...
App({
  onLaunch: function () {
    ...
    tim.on(TIM.EVENT.MESSAGE_REVOKED, function (event) {
      ...
      console.log(`============${event.name}==================`);
      console.log("===MESSAGE_REVOKED===" + JSON.stringify(event.data));
    });
    ...
    tim.on(TIM.EVENT.CONVERSATION_LIST_UPDATED, function (event) {
      ...
      console.log(`============${event.name}==================`);
      console.log("===CONVERSATION_LIST_UPDATED===" + JSON.stringify(event.data));
    });
    ...
    tim.on(TIM.EVENT.GROUP_LIST_UPDATED, function (event) {
      ...
      console.log(`============${event.name}==================`);
      console.log("===GROUP_LIST_UPDATED===" + JSON.stringify(event.data));
    });
    ...
    tim.on(TIM.EVENT.GROUP_SYSTEM_NOTICE_RECEIVED, function (event) {
      ...
      console.log(`============${event.name}==================`);
      console.log("===GROUP_SYSTEM_NOTICE_RECEIVED===" + JSON.stringify(event.data));
    });
    ...
    // IM登录
    let promise = tim.login({ userID: 'baohexin', userSig: genTestUserSig('baohexin').userSig });
