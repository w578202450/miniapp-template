...
module.exports = function (sendableMsg, type, myName) {
  ...
  if (type == msgType.TEXT) {
    //文本消息
    // msg.data = sendableMsg.payload.text; //文本内容
    // console.log("文本消息封装：" + JSON.stringify(sendableMsg));
    ...
    // console.log("图片消息封装：" + JSON.stringify(sendableMsg));
    msg.data = sendableMsg;
  } else if (type == msgType.AUDIO) {
    //音频消息
    // msg.url = sendableMsg.payload.url;
    // msg.length = sendableMsg.payload.second; //音频时长，单位：秒
    // console.log("音频消息封装：" + JSON.stringify(sendableMsg));
    msg.data = sendableMsg;
    ...
    //自定义消息
    // console.log("自定义消息封装：" + JSON.stringify(sendableMsg));
    msg.data = sendableMsg;
  }
  // var renderableMsg = {
  //   info: {
